/*******************************************************************************
    ...
    Test for removing a set of records with non-sequential keys via Remove
...
module dhttest.cases.UnorderedRemove;
...
/*******************************************************************************
    ...
    Put and then partially (50%) removed via Remove are correctly updated in the
    database.

*******************************************************************************/

class UnorderedRemoveTest : DhtTestCase
{
    ...
    {
        Description desc;
        desc.name = "Unordered Remove test";
        return desc;
    }
